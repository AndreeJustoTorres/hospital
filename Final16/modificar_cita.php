...
<body>
    <form class="col-4 p-3 m-auto" method="POST">
        ...
        <?php
        include "controlador/mod_cita.php";
        while ($datos=$sql->fetch_object()) { ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="hora" value="<?= $datos->hora ?>">
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">ID Administrativo</label>
                <input type="text" class="form-control" name="id_administrativo" value="<?= $datos->id_administrativo ?>">
            </div>
        <?php }
        ?>
