...
<body>
    ...
    <h1 class="text-center p-3">MÉDICO</h1>
    <?php
    ...
    <div class="container-fluid row">
        <form class="col-4 p-3" method="POST">
            <h3 class="text-center text-secondary">Registro Médicos</h3>
            <?php
                ...
                <tbody>
                    ...
                    while ($datos = $sql->fetch_object()) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="modificar_medico.php?id=<?= $datos->id ?>" class="btn btn-small btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                                <a onclick="return eliminar()" href="index_medico.php?id=<?= $datos->id ?>" class="btn btn-small btn-danger"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php }
                    ?>
    ...
    <a href="reporte3.php">OBTENER REPORTE</a>
