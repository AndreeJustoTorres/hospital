...
<body>
    ...
    include "controlador/eliminar_especialidad.php";
    ?>
    <div class="container-fluid row">
        <form class="col-4 p-3" method="POST">
            <h3 class="text-center text-secondary">Registro Especialidad</h3>
            <?php
            include "controlador/registro_especialidad.php";
            ?>
            <div class="mb-3">
                ...
                <tbody>
                    ...
                    while ($datos = $sql->fetch_object()) { ?>
                        <tr>
                            ...
                            <td><?= $datos->nombre ?></td>
                            <td>
                                <a href="modificar_especialidad.php?id=<?= $datos->id ?>" class="btn btn-small btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                                <a onclick="return eliminar()" href="index_especialidad.php?id=<?= $datos->id ?>" class="btn btn-small btn-danger"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php }
                    ?>
    ...
    <a href="reporte8.php">OBTENER REPORTE</a>
