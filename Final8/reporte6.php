...
$sql = " SELECT id, nombre, apellido, phone FROM enfermero ";
$resultado = $conexion->query($sql);

$excel = new Spreadsheet();
$hojaActiva = $excel->getActiveSheet();
$hojaActiva->setTitle("Tabla Enfermero");
...
header('Content-Disposition: attachment;filename="Tabla Enfermero.xlsx"');
