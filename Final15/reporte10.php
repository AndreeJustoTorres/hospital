...
$sql = " SELECT id, nombre, apellido FROM administrativo ";
$resultado = $conexion->query($sql);

$excel = new Spreadsheet();
$hojaActiva = $excel->getActiveSheet();
$hojaActiva->setTitle("Tabla Administrativo");
...
header('Content-Disposition: attachment;filename="Tabla Administrativo.xlsx"');
