...
$id=$_GET["id"];
$sql=$conexion->query(" SELECT * FROM diagnostico WHERE id=$id ");
...
<body>
    <form class="col-4 p-3 m-auto" method="POST">
        <h3 class="text-center text-secondary">Modificar diagnostico</h3>
        <input type="hidden" name="id" value="<?= $_GET["id"] ?>">
        <?php
        include "controlador/mod_diagnostico.php";
